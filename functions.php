...
<figure class="wp-block-image size-thumbnail is-resized"><img src="" alt="Luna Balance Logo" style="width:35px;height:35px"/></figure>
<!-- /wp:image -->
...
<!-- wp:navigation {"textColor":"charcoal","overlayMenu":"never","layout":{"type":"flex","justifyContent":"right"},"style":{"spacing":{"blockGap":"3rem"},"typography":{"fontSize":"0.85rem","fontWeight":"300"}}} -->
<!-- wp:navigation-link {"label":"HOME","url":"#"} /-->
<!-- wp:navigation-link {"label":"CLASSES","url":"#"} /-->
<!-- wp:navigation-link {"label":"ABOUT","url":"#"} /-->
<!-- wp:navigation-link {"label":"BOOK","url":"#"} /-->
<!-- /wp:navigation --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->',
    ...
    register_block_pattern(
        ...
        array(
            ...
            'content'     => '<!-- wp:cover {"url":"","dimRatio":20,"overlayColor":"base","minHeight":75,"minHeightUnit":"vh","contentPosition":"center center","style":{"spacing":{"padding":{"top":"0","bottom":"0"}}}} -->
<div class="wp-block-cover" style="min-height:75vh;padding-top:0;padding-bottom:0"><span aria-hidden="true" class="wp-block-cover__background has-base-background-color has-background-dim-20 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:group {"layout":{"type":"constrained","contentSize":"900px"}} -->
...
<h1 class="wp-block-heading has-text-align-center has-base-color has-text-color has-aboreto-font-family" style="margin-bottom:0;font-size:5rem;font-weight:300;letter-spacing:0.2em;line-height:1.2">FIND YOUR<br>INNER<br>PEACE</h1>
<!-- /wp:heading --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
...
<!-- /wp:separator -->',
    ...
    register_block_pattern(
        ...
        array(
            ...
            'content'     => '<!-- wp:group {"style":{"spacing":{"padding":{"top":"5rem","bottom":"5rem","left":"3rem","right":"3rem"}}},"backgroundColor":"base","layout":{"type":"constrained","contentSize":"1200px"}} -->
<div class="wp-block-group has-base-background-color has-background" style="padding-top:5rem;padding-right:3rem;padding-bottom:5rem;padding-left:3rem"><!-- wp:heading {"textAlign":"center","style":{"typography":{"fontSize":"2.5rem","fontWeight":"300","letterSpacing":"0.1em"},"spacing":{"margin":{"bottom":"2rem"}}},"textColor":"charcoal","fontFamily":"aboreto"} -->
...
<figure class="wp-block-image aligncenter size-large has-custom-border"><img src="" alt="Luna Balance yoga session" style="border-radius:0px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
...
<div class="wp-block-column" style="flex-basis:50%"><!-- wp:heading {"level":4,"style":{"typography":{"fontSize":"0.9rem","fontWeight":"400","letterSpacing":"0.05em"},"spacing":{"margin":{"bottom":"1rem"}}},"textColor":"charcoal"} -->
