document.addEventListener("DOMContentLoaded", function () {
  ...
  setTimeout(() => {
    ...
    if (eventSection) {
      ...
      const columnsContainer = eventContainer.querySelector(
        ".wp-block-columns.are-vertically-aligned-center",
      );

      if (columnsContainer) {
        const centerColumn = columnsContainer.querySelector(
        ...
        if (centerColumn) {
          ...
          if (!dotsContainer) {
            ...
            eventDate.parentNode.insertBefore(
              dotsContainer,
              eventDate.nextSibling,
            );
          }
          ...
          if (eventImage && eventTitle && eventDate && dotsContainer) {
            ...
            const events = [
              ...
              {
                image:
                  "https://aliciablomqvist.github.io/LunaBalance/wp-content/uploads/2026/02/maryjoy-caballero-6c9vcD2BSDM-unsplash-scaled.jpg",
              ...
              {
                image:
                  "https://aliciablomqvist.github.io/LunaBalance/wp-content/uploads/2026/02/photo-1578261260136-01d62b2d7d9e.avif",
            ...
            function changeEvent(index) {
              ...
              overlayImg.onload = () => {
                ...
                setTimeout(() => {
                  ...
                  const bookButton = centerColumn.querySelector(
                    ".wp-block-button__link",
                  );
                  if (bookButton) {
                    bookButton.setAttribute("data-event-id", events[index].id);
                  }

                  const dotsNow = centerColumn.querySelector(
  ...
  if (eventBookBtn) {
    ...
    eventBookBtn.addEventListener("click", function (e) {
      e.preventDefault();
      e.stopPropagation();
  ...
  const classDetails = {
    "Morning Flow": {
      ...
      level: "Beginner",
      description:
        "Start your day with gentle movements and breathwork. Perfect for beginners looking to build strength and flexibility.",
    ...
    "Deep Meditative Focus": {
      ...
      level: "Intermediate",
      description:
        "Dive deep into mindfulness with extended meditation and gentle asanas designed to calm the mind.",
    ...
    "Kundalini Yoga": {
      ...
      level: "Advanced",
      description:
        "Awaken your inner energy through powerful breathing techniques, mantras, and dynamic movements.",
    ...
    "Beginner Yoga Class": {
      ...
      level: "Beginner",
      description:
        "Learn the fundamentals of yoga in a supportive environment. No experience necessary.",
      benefits: [
        "Build foundation",
        "Gain confidence",
    ...
    "Classic Reiki Cleanse": {
      ...
      level: "Intermediate",
      description:
        "Experience the healing power of Reiki energy work to restore balance and harmony.",
    ...
    "Advanced Asana": {
      ...
      level: "Advanced",
      description:
        "Challenge yourself with complex poses and sequences. Strong foundation required.",
    ...
    "Prenatal Yoga": {
      ...
      level: "Beginner",
      description:
        "Gentle yoga designed for expecting mothers. Build strength, flexibility, and connect with your baby through mindful movement.",
      benefits: [
    ...
    "Yin Yoga": {
      ...
      level: "Intermediate",
      description:
        "Slow-paced practice holding poses for longer periods. Deep stretching and meditation combined for ultimate relaxation.",
      benefits: [
    ...
    "Power Vinyasa": {
      ...
      level: "Advanced",
      description:
        "Dynamic and challenging flow. Build heat, strength, and endurance through continuous movement and breath.",
      benefits: [
...
const lunaNav = document.querySelector(".luna-main-nav");
  ...
  document.addEventListener("click", (e) => {
    if (
      ...
      e.target.hasAttribute("data-event-id")
    ) {
      e.preventDefault();
  ...
  function showBookingForm(itemId, type) {
    ...
    bookingModal
      .querySelector(".luna-modal-close")
    ...
    bookingModal
      .querySelector(".luna-modal-overlay")
      .addEventListener("click", () => {
        bookingModal.classList.remove("active");
        setTimeout(() => bookingModal.remove(), 300);
      });
  ...
  (function () {
    ...
    setTimeout(() => {
      const menuToggle = document.querySelector(
        '.luna-main-nav .wp-block-navigation__responsive-container-open, .luna-main-nav button[aria-label*="Open"]',
      );
      const menuContainer = document.querySelector(
        ".luna-main-nav .wp-block-navigation__responsive-container",
      );
      ...
      setTimeout(() => {
        const menuClose = document.querySelector(
          '.luna-main-nav .wp-block-navigation__responsive-close, .luna-main-nav .is-menu-open button[aria-label*="Close"]',
        );
        if (menuClose) {
      ...
      document.addEventListener("click", (e) => {
        if (
          e.target.matches(
            ".luna-main-nav .is-menu-open .wp-block-navigation-item a",
          )
        ) {
          closeMenu();
        }
